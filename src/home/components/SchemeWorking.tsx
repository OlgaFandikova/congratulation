        ...
        return (
            <section className="section">
                <div className="container text-center">
                    <h2 className="text-secondary mb-10">Как мы работаем</h2>
                    <p className="font-18">Lorem ipsum dolor sit amet, consectetur</p>
                    <div className="row mt-100">
                        <div className="column sm-3 wow fadeInRight" {...delays[0]}>
                        ...
                        <div className="column sm-3 wow fadeInRight" {...delays[1]}>
                        ...
                        <div className="column sm-3 wow fadeInRight" {...delays[2]}>
                        ...
                        <div className="column sm-3 wow fadeInRight" {...delays[3]}>
